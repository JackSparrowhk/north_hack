...
远程命令执行类漏洞在漏洞利用阶段关注的问题主要是三个：**目标操作系统类型、执行命令结果是否有回显以及是否能通外网**。针对不同的操作系统，执行命令各有差异。另外，目标是否有回显是漏洞利用的难易程度的关键因素之一。最后目标是否能通外网也是直接影响漏洞利用的关键因素，如果漏洞无回显并且也不通外网，那漏洞利用难度就大大增加了。
...
![admin](data:image/gif;base64,R0lGODdhAQABAPAAAMPDwwAAACwAAAAAAQABAAACAkQBADs=)2022年6月20日*14:53:45*[*评论*](https://cn-sec.com/archives/1129108.html#respond)2,229 views字数 14151阅读47分10秒阅读模式
...
![命令执行漏洞[无]回显[不]出网利用技巧](http://cn-sec.com/wp-content/uploads/2022/06/9-1655688150.png)
...
![命令执行漏洞[无]回显[不]出网利用技巧](http://cn-sec.com/wp-content/uploads/2022/06/6-1655688152.png)

![命令执行漏洞[无]回显[不]出网利用技巧](http://cn-sec.com/wp-content/uploads/2022/06/1-1655688154.png)
...
![命令执行漏洞[无]回显[不]出网利用技巧](http://cn-sec.com/wp-content/uploads/2022/06/2-1655688156.png)
...
![命令执行漏洞[无]回显[不]出网利用技巧](http://cn-sec.com/wp-content/uploads/2022/06/4-1655688157.png)
...
![命令执行漏洞[无]回显[不]出网利用技巧](http://cn-sec.com/wp-content/uploads/2022/06/2-1655688159.png)
...
![命令执行漏洞[无]回显[不]出网利用技巧](http://cn-sec.com/wp-content/uploads/2022/06/3-1655688161.png)
...
![命令执行漏洞[无]回显[不]出网利用技巧](http://cn-sec.com/wp-content/uploads/2022/06/4-1655688164.png)
...
![命令执行漏洞[无]回显[不]出网利用技巧](http://cn-sec.com/wp-content/uploads/2022/06/1-1655688166.png)
...
![命令执行漏洞[无]回显[不]出网利用技巧](http://cn-sec.com/wp-content/uploads/2022/06/1-1655688168.png)

其中index.html.path.txt为路径：

![命令执行漏洞[无]回显[不]出网利用技巧](http://cn-sec.com/wp-content/uploads/2022/06/4-1655688170.png)

index.html.ipconfig.txt为ifconfig执行的命令结果：

![命令执行漏洞[无]回显[不]出网利用技巧](http://cn-sec.com/wp-content/uploads/2022/06/8-1655688172.png)
...
![命令执行漏洞[无]回显[不]出网利用技巧](http://cn-sec.com/wp-content/uploads/2022/06/0-1655688174.png)
...
![命令执行漏洞[无]回显[不]出网利用技巧](http://cn-sec.com/wp-content/uploads/2022/06/6-1655688177.png)
...
![命令执行漏洞[无]回显[不]出网利用技巧](http://cn-sec.com/wp-content/uploads/2022/06/10-1655688179.png)
...
![命令执行漏洞[无]回显[不]出网利用技巧](http://cn-sec.com/wp-content/uploads/2022/06/9-1655688181.png)



###### **方法二、locate**

![命令执行漏洞[无]回显[不]出网利用技巧](http://cn-sec.com/wp-content/uploads/2022/06/0-1655688183.png)
...
![命令执行漏洞[无]回显[不]出网利用技巧](http://cn-sec.com/wp-content/uploads/2022/06/7-1655688186.png)
...
**1、查看IP与域名绑定的历史记录，可能会存在使用CDN前的记录，相关查询网站有：**
